...
function isValid(formula) {
  ...
  //////////////////////////////////////!SECTION
  //   switch (true) {
  //     case formula.includes(1) && formula.includes(2):
  //       return false;
  //     case formula.includes(3) && formula.includes(4):
  //       return false;
  //     case formula.includes(5) !== formula.includes(6):
  //       return false;
  //     case !(formula.includes(7) || formula.includes(8)):
  //       return false;
  //     default:
  //       return true;
  //   }
